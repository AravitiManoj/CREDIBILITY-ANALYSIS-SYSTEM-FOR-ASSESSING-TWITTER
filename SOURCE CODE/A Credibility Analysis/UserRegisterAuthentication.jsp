					...
					if ( rs1.next() )
					   {
							...
							%>
							<p><a href="UserRegister.jsp">Back</a>         <a href="index.html">Home</a> </p>
					   ...
					   {
						PreparedStatement ps=connection.prepareStatement("insert into user(name,pass,email,mobile,addr,dob,gender,status,imagess) values(?,?,?,?,?,?,?,?,?)");
